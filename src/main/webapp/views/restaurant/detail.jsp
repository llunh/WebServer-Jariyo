...
<%
    RestaurantDTO      restaurant = (RestaurantDTO)      request.getAttribute("restaurant");
    ArrayList<MenuDTO> menus      = (ArrayList<MenuDTO>) request.getAttribute("menus");
%>
<html>
<head>
<meta charset="UTF-8">
<link rel="stylesheet" href="<c:url value='/resources/css/bootstrap.min.css'/>">
<title><%= restaurant.getName() %> - 상세</title>
<style>
...
<div class="container mt-4">
    ...
    <!-- 식당 정보 -->
    <img src="<%= request.getContextPath() %>/resources/images/<%= restaurant.getImageFilename() %>"
         class="restaurant-img w-100 rounded-3">
    <h2 class="mt-3"><%= restaurant.getName() %></h2>
...
<div class="container mt-4">
    ...
    <div class="row">
        ...
        <div class="col-md-3 mb-3">
            <div class="card">
                <img src="<%= request.getContextPath() %>/resources/images/<%= menu.getImageFilename() %>"
...
<div class="container mt-4">
    <h3>예약 신청</h3>
    <form action="<c:url value='/ReservationAction.do'/>" method="post">
